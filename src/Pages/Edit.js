...
class Edit extends react.Component {
    ...
    componentDidMount() { 
        ...
        //alert("in tb edit"+this.props.location.state.userRole)
       ...
       axios.get(process.env.REACT_APP_BASE_URL +'/getTumorboardDetails?tbid='+ x)
        .then(res => {
          ...
          this.setState({ aiOpinion: pdetails.aiOpinion })
        })
    }
          ...
          <div id="sub_header">
            ...
            <div id="header_sec_2">
              ...
              <div id="header_buttons">
               { this.state.userRole == "doctor" && <button id="back"><Link to={{ pathname: '/doctor', state: { start_time: this.state.start_time,userRole: this.state.userRole } }}> Home</Link></button>}
                {this.state.userRole != "doctor" && <button id="back"><Link to={{ pathname: '/tumorboardinterface' }} >Home</Link></button>}        
               <Link to={{ pathname: '/Tumorboarddetails', state: { tbid: this.state.tbid,userRole: this.state.userRole  } }}><button  id="Details">Details</button></Link>
                </div>
            </div>
            <div id="header_sec_3">
                ...
                <div className="container" style={{ width: '100%', display: 'flex', maxWidth: '1800px', background: '#eee' }}>
                    ...
                    <div id="content_div">
                       <div id="tabnotification"  style={{ }}>
                        <div id="content_header"><h3>Edit Tumorboard</h3>
                        <h5 className="field">TBID:{this.props.location.state.tbid} </h5>
                            ...
                            >
                                <div id="testModal" style={{ width: "70%" }}>
                                        ...
                                        <div>
                                            ...
                                            <div style={{ display: "flex" }}>
                                                ...
                                                <div className="w_sec w_sec_select_50">
                                                     <h5 className="field">Location</h5>
                                    ...
                                    <section>
                                        <div style={{ display: "flex" }}>
                                            ...
                                            <div className="w_sec w_sec_select_50">
                                                 <h5 className="field">Duration</h5>
                                    ...
                                    <section>
                                        <div style={{ display: "flex" }}>
                                            <div className="w_sec w_sec_select_50">
                                                 <h5 className="field">Tumor Board Type*</h5>
                                ...
                                <div style={{ paddingTop: 7, paddingLeft: 130 }}>
                                    ...
                                    <div className="w_sec w_sec_select_50" style={{ width: '75%' }}>
                                         <h5 className="field">Repeat Frequency</h5>
